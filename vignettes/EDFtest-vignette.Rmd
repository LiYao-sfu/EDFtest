...
According to rule of thumb, we will reject null hypothesis, which is $F$ is a member of gamma family when P-value of $A^{2}$ is greater than ??? or P-value of $W^{2}$ is greater than ???. Note that, both... In conclusion, the gamma distribution is a good model for this sample.
