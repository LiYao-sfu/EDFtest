#' EDF Goodness-of-Fit tests for Weibull Distribution by Bootstrap
#'
...
#'
#' @return gof.weibull.bootstrap computes Cramer-von Mises and Anderson-Darling statistics and their P-values by bootstrap.
#' @export
#'
#' @examples
#' x=rweibull(1000,1)
#' gof.weibull.bootstrap(x,M=1000)
#' gof.weibull(x)
