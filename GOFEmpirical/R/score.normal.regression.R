...
score.normal.regression = function(y,x,theta.hat){
  #
  # This computes an n by p+1 matrix containing the components of the
  #  score function in a linear regression of y on the n x p covariate matrix x
  # The ith row of the output corresponds to the ith data point.
  # Column 1 of the output is the sigma component of the score.
  # Columns 2 to p+1 are the components of the score corresponding to the
