...
<img src="https://render.githubusercontent.com/render/math?math=Laplace(location = \mu, scale = \beta), Weibull(shape = \alpha, scale = \beta), Extreme Value(location = \mu, scale = \beta)">
